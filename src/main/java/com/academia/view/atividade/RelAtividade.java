...
public class RelAtividade extends JDialog {

	private static final long serialVersionUID = 2241274667387194631L;
	
	private final JPanel contentPanel = new JPanel();
	
	public RelAtividade(JFrame frame, boolean modal) {
	...
	private void imprimeRelatorioPorLista() {
	    ...
	    List<Atividade> listaAtividade = AtividadeService.findAll();
		
		printJasperReport.setFile("rel_atividade");
		printJasperReport.setCollection(listaAtividade);
		setVisible(false);
